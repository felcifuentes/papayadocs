...
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if (typeof window &amp;&amp; window.Vue) {
<span class="cstat-no" title="statement not covered" >  window.Vue.use(VueI18n);</span>
}
&nbsp;</pre></td></tr>
</table></pre>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Sun May 28 2017 21:01:32 GMT+0000 (UTC)
</div>
</div>
