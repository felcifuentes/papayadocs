...
var Server = (function () {
    ...
    Server.prototype.init = function (options) {
        this.sendServerPreInitEvent(options);
        this.registerResources();
        this.sendServerInitEvent(options);
    };
    ...
    Server.prototype.sendServerPreInitEvent = function (options) {
        var _this = this;
        glimpse_common_2.getTelemetryAppInstanceData(this._configSettings, function (appData) {
            var props = __assign({}, appData, { glimpseLaunchMechanism: options && options.glimpseLaunchMechanism });
            var measurements = {};
            _this._telemetryService.sendEvent(glimpse_common_2.TelemetryEvents.NODE_SERVER_PRE_INIT, props, measurements);
        });
    };
    Server.prototype.sendServerInitEvent = function (options) {
        var _this = this;
        glimpse_common_2.getTelemetryAppInstanceData(this._configSettings, function (appData) {
            var props = __assign({}, appData, { glimpseLaunchMechanism: options && options.glimpseLaunchMechanism });
            var measurements = {};
            _this._telemetryService.sendEvent(glimpse_common_2.TelemetryEvents.NODE_SERVER_INIT, props, measurements);
        });
    };
    return Server;
}());
