...
export declare class Resource implements IResource {
    ...
    getAppInstanceData(cb: (appInstanceData: ITelemetryAppInstanceData) => void): void;
    /**
     *  returns an ITelemetryConfig object with the appropriate values.
     */
    createTelemetryConfig(clientIP: string, cb: (config: IClientTelemetryInfo) => void): void;
    /**
     * Invoke the resource
     */
