...
export class Server implements IServer {
    ...
    public init(options?: IServerOptions) {
    ...
    private sendServerPreInitEvent(options: IServerOptions) {
        getTelemetryAppInstanceData(this._configSettings, (appData) => {
            const props: IProperties = {
                ...appData,
                glimpseLaunchMechanism: options && options.glimpseLaunchMechanism
            };
            const measurements: IMeasurements = {};
            this._telemetryService.sendEvent(TelemetryEvents.NODE_SERVER_PRE_INIT, props, measurements);
        });
    }

    private sendServerInitEvent(options: IServerOptions) {
        getTelemetryAppInstanceData(this._configSettings, (appData) => {
            const props: IProperties = {
                ...appData,
                glimpseLaunchMechanism: options && options.glimpseLaunchMechanism
