...
import { ContextManagerZones } from './ContextManagerZones';
...
export class ContextManagerProvider {
    ...
    public static getContextManager(): IContextManager {
        if (!ContextManagerProvider.defaultInstance) {
            ...
            if (!ContextManagerProvider.defaultInstance) {
                ...
                //ContextManagerProvider.defaultInstance = ContextManagerProvider.createZonesContextManager();
            }
    ...
    private static getCommandLineOverride(): IContextManager {
        ...
        for (let i = 0; i < process.argv.length; i++) {
            ...
            if (lcaseSwitch === '--glimpse.contextmanager' || lcaseSwitch === '--glimpse.cm') {
                ...
                else if (lcaseVal === 'zones') {
                    cm = ContextManagerProvider.createZonesContextManager();
                    break;
                }
    ...
    private static createZonesContextManager(): ContextManagerZones {
        const cm: ContextManagerZones = new ContextManagerZones();
        cm.init();
        return cm;
    }
