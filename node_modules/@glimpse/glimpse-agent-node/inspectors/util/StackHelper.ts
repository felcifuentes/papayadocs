...
export class StackHelper implements IStackHelper {
    ...
    public constructor(private configSettings: IConfigSettings, private errorReportingService: IErrorReportingService | undefined) {
    }
    ...
    public captureStack(stackTopFunction, numFrames?: number): IStackFrame[] {
        ...
        if (numFrames === undefined) {
            numFrames = this.configSettings.get(
                'stack-manager.capture-size',
                // NOTE: For back-compat we'll fall back to the original ConsoleProxy string.
                this.configSettings.get('instrumentor.console.stack-capture.size', 10));
        }
