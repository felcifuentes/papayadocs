...
export const EVENT_HTTP_CLIENT_REQUEST_CLOSE = 'invoke|post|module:httpClient.request-close';
...
export const EVENT_HTTP_CLIENT_RESPONSE_ABORTED = 'notify|module:httpClient.response-aborted';
