...
var ClientRequestInspector = (function () {
    ...
    ClientRequestInspector.prototype.init = function (agent, errorReportingService) {
        ...
        this.listeners = (_a = {},
            ...
            _a[HttpEvents_1.EVENT_HTTP_CLIENT_REQUEST_CLOSE] = function (event) { return _this.onRequestClose(event); },
            ...
            _a[HttpEvents_1.EVENT_HTTP_CLIENT_RESPONSE_ABORTED] = function (event) { return _this.onResponseDone(event); },
            _a[HttpEvents_1.EVENT_HTTP_CLIENT_RESPONSE_END] = function (event) { return _this.onResponseDone(event); },
    ...
    ClientRequestInspector.prototype.onRequestClose = function (event) {
    ...
    ClientRequestInspector.prototype.onResponseDone = function (event) {
        var eventData = event.data;
        var masterData = this.requests[eventData.id];
        if (masterData) {
