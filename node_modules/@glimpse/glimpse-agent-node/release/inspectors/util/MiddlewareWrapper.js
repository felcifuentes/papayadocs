...
var MiddlewareWrapper = (function () {
    ...
    MiddlewareWrapper.prototype.wrap = function (paths, method, originalMiddleware, registrationCallstack) {
        if (originalMiddleware && typeof originalMiddleware === 'function') {
            var newMiddleware = void 0;
            if (originalMiddleware.length === 2 || originalMiddleware.length === 3) {
                newMiddleware = this.wrapMiddleware(paths, method, originalMiddleware, registrationCallstack);
            }
            else if (originalMiddleware.length === 4) {
                newMiddleware = this.wrapErrorMiddleware(paths, method, originalMiddleware, registrationCallstack);
            }
            if (newMiddleware) {
