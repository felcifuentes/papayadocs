...
var StackHelper = (function () {
    function StackHelper(configSettings, errorReportingService) {
    ...
    StackHelper.prototype.captureStack = function (stackTopFunction, numFrames) {
        ...
        if (numFrames === undefined) {
            numFrames = this.configSettings.get('stack-manager.capture-size', 
    ...
    StackHelper.prototype.parseFrameEntry = function (source) {
        var openParen, closeParen, firstOpenParen, colon1, colon2;
        var openParenStack = [];
