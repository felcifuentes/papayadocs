...
var ContextManagerAsyncTrack = (function (_super) {
    ...
    ContextManagerAsyncTrack.prototype.init = function (asyncTrack) {
        ...
        var handler = {
            ...
            onError: function onError(msg) {
                if (self.getErrorReportingService()) {
                    self.getErrorReportingService().reportError(glimpse_common_1.createAsyncTrackError(msg));
                }
            },
            onWarning: function onWarning(msg) {
                if (self.getErrorReportingService()) {
                    self.getErrorReportingService().reportError(glimpse_common_1.createAsyncTrackWarning(msg));
                }
            }
        };
    ...
    ContextManagerAsyncTrack.prototype.getName = function () {
