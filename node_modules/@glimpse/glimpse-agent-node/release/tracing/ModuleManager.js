...
var ModuleManager = (function () {
    function ModuleManager() {
        ...
        this.instrumentedModules = {}; // tslint:disable-line:no-any
    }
    ModuleManager.prototype.init = function (agent, moduleModule) {
        ...
        var glimpseRequire = function glimpseRequire(moduleId) {
            ...
            var managedModule = self.instrumentedModules[modulePath] || originalModule;
            ...
            if (self.moduleInstrumentors[moduleId] && isEnabled) {
                var moduleInfo = ModuleIdentifier_1.getModuleInfo(moduleId, modulePath, managedModule);
    ...
    ModuleManager.prototype.isModuleInstrumented = function (moduleId) {
